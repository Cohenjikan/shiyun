...
> - **权威事实源**：`public/data/manifest.json` v3 —— `N=12877`、`poetCount=32657`、`poemCount=933857`、`giftEdges=4976`、`poemSidecar=true`。任何与此冲突的数字以 manifest 为准。
...
| ID | 问题 | 根因桶 | 状态 |
|---|---|---|---|
| **UF-01** | 毛泽东《到韶山》「敢叫」错字 + 89 首疑不全 | upstream-typo（+ 子问题 upstream-missing） | 📋 |
| **UF-02** | 唐温如《题龙阳县青草湖》裂成 3 身／误作《过洞庭》 | upstream-duplication（+ 次生 朝代／命名） | 📋 |
| **UF-03** | 陆游 10565 首计数虚高（应 ≈9344） | upstream-duplication（+ 古典「刻意不去重」设计） | 📋 |
...
| **UF-07** | 叶嘉莹未收录 | upstream-missing | 📋 |
| **UF-08** | 兰楚芳未收录（散曲家） | upstream-missing | 📋 |
| **UF-09** | 李白《王昭君·汉家秦地月》疑缺 | **not-an-error**（已完整在库） | 🧊 |
| **UF-10** | 袁枚《所见》疑缺 | upstream-missing | 📋 |
