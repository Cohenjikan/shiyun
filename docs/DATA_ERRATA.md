...
> - **权威事实源**：`public/data/manifest.json` v3 —— `N=12877`、`poetCount=32657`、`poemCount=933857`、`giftEdges=4976`、`poemSidecar=true`。任何与此冲突的数字以 manifest 为准。(2026-07-08 换源+勘误后现值:N=22219、poetCount=33458、poemCount=970320、giftEdges=5165。)
...
| **UF-02** | 唐温如《题龙阳县青草湖》裂成 3 身／误作《过洞庭》 | upstream-duplication（+ 次生 朝代／命名） | ✅讹字已修(玉箫→西风)·三身合并仍📋红线 |
